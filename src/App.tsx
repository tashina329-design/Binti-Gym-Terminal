...
import { subscribeLiveSync, broadcastLiveSync } from './lib/firebaseSync';
...
export default function App() {
  ...
  // Real-Time Firebase Firestore Live Sync across all devices
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-3 sm:p-5 lg:p-8 font-sans pb-28 md:pb-8 relative">
      ...
      {/* Security Pin Code Verification Modal */}
      <PinCodeModal
        isOpen={showPinModal}
        correctPin={staffPin}
        registeredStaff={registeredStaff}
