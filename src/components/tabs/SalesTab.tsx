      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          <div className="bg-slate-900 border border-slate-700 p-3.5 rounded-xl">
            ...
            <h3 className="text-lg font-bold text-slate-100 mt-1">${data.posSalesTotal.toFixed(2)}</h3>
          </div>
          <div className="bg-slate-900 border border-slate-700 p-3.5 rounded-xl">
            <span className="text-[11px] font-semibold text-slate-400 uppercase">💃 Classes</span>
            <h3 className="text-lg font-bold text-purple-400 mt-1">${data.classSalesTotal.toFixed(2)}</h3>
          </div>
          <div className="bg-slate-900 border border-slate-700 p-3.5 rounded-xl">
            <span className="text-[11px] font-semibold text-slate-400 uppercase">🏋️‍♂️ PT Payment IN</span>
            <h3 className="text-lg font-bold text-emerald-400 mt-1">${data.ptSalesTotal.toFixed(2)}</h3>
          </div>
          <div className="bg-slate-900 border border-slate-700 p-3.5 rounded-xl">
            <span className="text-[11px] font-semibold text-slate-400 uppercase">💸 PT Payment OUT</span>
            <h3 className="text-lg font-bold text-rose-400 mt-1">${data.ptPayoutTotal.toFixed(2)}</h3>
          </div>
          <div className="bg-slate-900 border border-slate-700 p-3.5 rounded-xl">
            <span className="text-[11px] font-semibold text-slate-400 uppercase">👟 Walk-In Passes</span>
            <h3 className="text-lg font-bold text-sky-400 mt-1">${data.walkInSalesTotal.toFixed(2)}</h3>
          </div>
          <div className="bg-slate-900 border border-slate-700 p-3.5 rounded-xl">
            <span className="text-[11px] font-semibold text-slate-400 uppercase">💳 Memberships</span>
            <h3 className="text-lg font-bold text-emerald-400 mt-1">${data.membershipSalesTotal.toFixed(2)}</h3>
          </div>
        </div>
      </div>
