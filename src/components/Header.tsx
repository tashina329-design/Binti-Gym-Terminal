...
import { Dumbbell, RefreshCw, QrCode, Monitor, UserCheck, Bell, X, CheckCircle2, Lock, LogOut } from 'lucide-react';
    ...
    <header className="flex flex-col lg:flex-row justify-between items-start lg:items-center pb-4 mb-6 border-b border-slate-800 gap-4 relative">
      <div className="flex flex-wrap items-center gap-2.5">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">Gym Operations & Daily Financial Ledger</p>
        </div>

        {/* Working Staff Shift Status Badge */}
        <button
          onClick={onOpenShiftModal}
          className={`ml-0 sm:ml-2 px-3 py-1.5 rounded-xl text-xs font-bold flex items-center gap-2 border transition-all ${
            activeShift
